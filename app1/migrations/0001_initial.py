# Generated by Django 4.0.6 on 2022-10-06 09:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Draft', 'Draft'), ('Approved', 'Approved'), ('Sales Order', 'Sales Order')], default='Draft', max_length=150)),
                ('cid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.company')),
            ],
        ),
        migrations.CreateModel(
